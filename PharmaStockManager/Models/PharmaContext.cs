    ...
    public class PharmaContext : IdentityDbContext<AppUser, AppRole, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Drug>().HasData(
                ...
                new Drug { Id = 4, Name = "Ibuprofen", Category = "Painkillers", Quantity = 150, UnitPrice = 6.50m, DrugType = "Tablet", RefCode = "ADMIN001" },
                new Drug { Id = 5, Name = "Azithromycin", Category = "Antibiotics", Quantity = 70, UnitPrice = 10.00m, DrugType = "Capsule", RefCode = "ADMIN001" },
